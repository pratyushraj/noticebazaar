...
ALTER TABLE public.dental_patients ADD COLUMN IF NOT EXISTS before_photo TEXT;
ALTER TABLE public.dental_patients ADD COLUMN IF NOT EXISTS after_photo TEXT;
