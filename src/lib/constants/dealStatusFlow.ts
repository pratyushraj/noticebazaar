...
export const DEAL_STAGE_DISPLAY: Record<DealStageKey, StageDisplayConfig> = {
  ...
  fully_executed: {
    ...
    helperTextPaid: 'Brand will release payment after your content is approved',
  ...
  content_making: {
    ...
    helperText: 'Create your post and share the link',
    helperTextPaid: 'Create your post and share the link with the brand',
  ...
  content_delivered: {
    ...
    helperText: 'Brand will review and approve',
