...
<head>
  <meta charset="UTF-8">
  <title>Contract Analysis Report - CreatorArmour</title>
  <style>
...
<body>
  <div class="page">
    ...
    <div class="header">
      ...
      <div class="subtitle">Generated by CreatorArmour AI Protection System</div>
    ...
    <div class="section">
      ...
      <div class="next-steps">
        <ol>
          ...
          <li><strong>Schedule Legal Review:</strong> Consult with CreatorArmour's legal advisor to discuss specific changes needed.</li>
          ...
          <li><strong>Re-Upload for Review:</strong> Once revised, upload the new contract to CreatorArmour for verification.</li>
        </ol>
      </div>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
      <div class="footer-logo">CreatorArmour</div>
      <div>Legal & Tax Services for Content Creators & Influencers</div>
      <div class="footer-disclaimer">
        This report is generated by AI and should be reviewed by a qualified legal professional before making final decisions. CreatorArmour provides this analysis as guidance only and does not constitute legal advice.
      </div>
      <div class="footer-copyright">
        © ${currentDate.getFullYear()} CreatorArmour. All rights reserved. | Report ID: ${reportId}
      </div>
    </div>
  </div>
</body>
  ...
  try {
    ...
    const safeFileName = (fileName || 'Contract_Report')
      .replace(/[^a-z0-9]/gi, '_')
      .toLowerCase();
    pdf.save(`CreatorArmour_Contract_Report_${safeFileName}_${reportId}.pdf`);
  } catch (error) {
    // Clean up on error
