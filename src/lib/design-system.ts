...
export const buttons = {
  ...
  // Ecosystem-aligned (Brand light + Creator dark)
  ecosystemPrimary: "bg-gradient-to-r from-emerald-500 to-sky-500 text-white font-black uppercase tracking-widest rounded-2xl shadow-[0_12px_36px_rgba(16,185,129,0.22)] active:scale-[0.99] transition-all",
  ecosystemSecondaryDark: "border border-white/10 bg-white/5 text-white/80 hover:bg-white/10 rounded-2xl font-bold transition-all active:scale-[0.99]",
  ecosystemSecondaryLight: "border border-emerald-200/70 bg-white/70 text-slate-800 hover:bg-white/80 rounded-2xl font-bold transition-all active:scale-[0.99]",
} as const;
