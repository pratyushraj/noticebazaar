  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: 10 }}
        className="absolute top-full left-0 mt-2 w-80 bg-black/90 backdrop-blur-xl border border-border rounded-2xl shadow-2xl p-4 z-50"
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <button type="button"
            onClick={onClose}
            className="w-6 h-6 rounded-full bg-secondary/50 hover:bg-secondary/20 flex items-center justify-center transition-colors"
