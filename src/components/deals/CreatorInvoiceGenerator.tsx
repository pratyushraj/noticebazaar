                    ...
                    <div className="flex justify-between items-start border-b border-gray-200 pb-8 mb-8">
                        ...
                        <div className="text-right flex flex-col items-end">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <h2 className="text-xl font-bold text-muted-foreground">CreatorArmour</h2>
                            </div>
                            <p className="text-sm text-gray-500 max-w-[200px]">Generated via CreatorArmour infrastructure for compliant creator payments.</p>
                        </div>
                    </div>
