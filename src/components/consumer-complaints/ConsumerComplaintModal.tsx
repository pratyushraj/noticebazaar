            ...
            <div className="space-y-4 py-4">
              ...
              <div className="pt-2 border-t border-purple-500/20">
                <p className="text-xs text-foreground/50 text-center">
                  These services are complimentary during a limited pilot. Creator Armour does not act as legal counsel unless explicitly agreed.
                </p>
              </div>
            ...
            <DialogHeader>
              <div className="flex items-start justify-between gap-4 mb-2">
                ...
                <a
                  ...
                  aria-label="Learn how consumer complaints work on Creator Armour"
                >
