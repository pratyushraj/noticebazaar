    ...
    >
      <GradientCard padding="lg" className="max-w-2xl mx-auto">
        <div className="mb-3 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-base text-slate-500 dark:text-white/80 max-w-xl">
            Add simple starting prices brands can understand fast. You can change these later.
          </p>
          <button
            type="button"
            onClick={onAutoSuggestPrices}
            className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 px-3.5 py-2 text-xs font-bold text-white shadow-[0_8px_20px_rgba(16,185,129,0.28)] transition-all hover:from-emerald-600 hover:to-teal-600 active:scale-[0.98] whitespace-nowrap"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-7">
          <div className="rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_4px_12px_rgba(15,23,42,0.05)]">
          ...
          <div className="rounded-2xl border-2 border-amber-300 bg-gradient-to-b from-amber-50/60 to-white p-3 shadow-[0_8px_18px_rgba(245,158,11,0.15)]">
