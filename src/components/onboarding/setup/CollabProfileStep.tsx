        ...
        <div className="space-y-4 mb-7">
          <label className="block">
            ...
            <textarea
              ...
              className="w-full bg-background dark:bg-card border border-border dark:border-border rounded-xl px-4 py-3 text-sm text-muted-foreground dark:text-foreground placeholder-slate-400 dark:placeholder-white/50 outline-none focus:border-primary transition-colors resize-none"
            />
            <p className="mt-1 text-[11px] text-muted-foreground dark:text-foreground/50">Keep it short and useful. Minimum 20 characters.</p>
