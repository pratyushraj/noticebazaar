  ...
  return (
    <Card className="bg-[#0F121A]/80 backdrop-blur-xl border border-border/5 rounded-2xl">
      <CardContent className="p-4 sm:p-6">
        <div className="mb-4">
          <h3 className="text-base font-semibold text-foreground mb-1">Activity & Analytics</h3>
          <p className="text-xs text-foreground/50">Performance metrics and insights</p>
        </div>
