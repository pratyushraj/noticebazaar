      ...
      <section className="rounded-3xl border border-white/10 bg-[#111827]/90 p-5 shadow-[0_18px_50px_rgba(15,23,42,0.45)]">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-300">
                Move from signup to first offer, then keep tightening your storefront and payout setup as your deal flow grows.
              </p>
            </div>
        ...
        <div className="mt-5">
          <div className="mb-3 flex items-center justify-between">
            <div>
              <p className="text-sm font-bold text-white">Progressive checklist</p>
              <p className="text-xs text-slate-400">{pendingItems.length} items left before your storefront feels complete.</p>
            </div>
          </div>
