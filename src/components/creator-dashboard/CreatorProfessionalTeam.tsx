      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {charteredAccountant ? (
          <div className="relative flex flex-col space-y-4 rounded-[14px] p-5 
                          ...
                          border border-info/30 backdrop-blur-xl shadow-inner
                          hover:border-info/40 hover:from-blue-500/25 hover:via-blue-500/15 
            ...
            <div className="relative z-10 flex items-center space-x-4">
              <div className="relative">
                <Avatar className="h-14 w-14 flex-shrink-0 ring-2 ring-blue-500/30 group-hover:ring-blue-500/50 transition-all">
                  ...
                  <AvatarFallback className="bg-gradient-to-br from-blue-600 to-blue-700 text-foreground text-lg">
                    {getInitials(charteredAccountant.first_name, charteredAccountant.last_name)}
                  </AvatarFallback>
                </Avatar>
                <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full bg-green-500 border-2 border-info/20"></div>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-lg font-bold text-foreground truncate">{caName}</p>
                <p className="text-sm text-foreground/70 truncate">Tax & Accounting Advisor</p>
                ...
                <p className="text-xs text-foreground/60 mt-1">Replies in ~12 min</p>
            ...
            <Button
              ...
              className="relative z-10 w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 
                         ...
                         border border-info/30 active:scale-[0.98] transition-all duration-150"
            ...
            <div className="relative z-10 grid grid-cols-3 gap-3 text-center pt-3 border-t border-border">
              <div>
              ...
              <div>
                <p className="text-lg font-bold text-foreground flex items-center justify-center">4.8<Star className="h-4 w-4 text-yellow-400 ml-0.5" fill="currentColor" /></p>
          ...
          <div className="flex flex-col items-center justify-center py-8 rounded-[14px] p-5 
                          ...
                          border border-border backdrop-blur-xl shadow-inner">
            <Calculator className="h-12 w-12 text-foreground/30 mb-2" />
            <p className="text-sm text-foreground/60 text-center">No CA available</p>
          </div>
        )}
        ...
        {legalAdvisor ? (
          <div className="relative flex flex-col space-y-4 rounded-[14px] p-5 
            ...
            <div className="relative z-10 flex items-center space-x-4">
              <div className="relative">
                <Avatar className="h-14 w-14 flex-shrink-0 ring-2 ring-purple-500/30 group-hover:ring-purple-500/50 transition-all">
                  ...
                  <AvatarFallback className="bg-gradient-to-br from-purple-600 to-purple-700 text-foreground text-lg">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-foreground/70 truncate">Legal Advisor</p>
                <div className="flex items-center gap-2 mt-1.5">
                  <span className="relative flex h-2.5 w-2.5">
                    <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-green-500"></span>
                ...
                <p className="text-xs text-foreground/60 mt-1">Replies in ~8 min</p>
                <div className="flex items-center gap-1 mt-1">
                  <span className="text-[10px] text-green-400/80 font-medium">Available now</span>
                </div>
              </div>
            ...
            <div className="relative z-10 grid grid-cols-3 gap-3 text-center pt-3 border-t border-border">
              <div>
                ...
                <p className="text-xs text-foreground/60">Cases Won</p>
              </div>
              <div>
                <p className="text-lg font-bold text-foreground">2 Yrs</p>
                <p className="text-xs text-foreground/60">Experience</p>
              ...
              <div>
                <p className="text-lg font-bold text-foreground flex items-center justify-center">4.9<Star className="h-4 w-4 text-yellow-400 ml-0.5" fill="currentColor" /></p>
                <p className="text-xs text-foreground/60">Rating</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-8 rounded-[14px] p-5 
                          ...
                          border border-border backdrop-blur-xl shadow-inner">
            <Scale className="h-12 w-12 text-foreground/30 mb-2" />
            <p className="text-sm text-foreground/60 text-center">No Legal Advisor available</p>
          </div>
        )}
      </CardContent>
    </Card>
