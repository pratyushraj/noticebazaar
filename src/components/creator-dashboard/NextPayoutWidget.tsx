  ...
  return (
    ...
    >
      <Card className={cn(
        ...
        statusInfo.status === 'processing' && "bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 border-info/30",
        ...
        <CardContent className="p-6 relative z-10">
          <div className="space-y-4">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <IndianRupee className="w-5 h-5 text-foreground/80" />
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm text-foreground/60">
                    from <span className="font-semibold text-foreground/90">{deal.brand_name}</span>
                  </span>
                </div>
              </div>
              <div className="h-16 w-16 rounded-2xl bg-secondary/50 backdrop-blur-sm border border-border flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              <div className="flex items-center gap-3">
                ...
                <div className={cn(
                  ...
                  {statusInfo.status === 'processing' && <Clock className="w-4 h-4 text-info" />}
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm text-foreground/70">
                    Due: <span className="font-semibold text-foreground">{formattedDate}</span>
                  </span>
            ...
            {statusInfo.status === 'processing' && (
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-foreground/60">Payout Progress</span>
            ...
            <Button
              ...
              className={cn(
                "w-full bg-secondary/50 hover:bg-secondary/20 border border-border text-foreground rounded-xl transition-all",
