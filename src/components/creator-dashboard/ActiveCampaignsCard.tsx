      ...
      {activeCampaigns === 0 ? (
        ...
        <>
          <CardContent>
            ...
            <div className="text-[13px] text-foreground/60 mt-1">
            ...
            {campaignWithDeliverable && (
              <div className="mt-3 p-3 bg-card rounded-lg border border-yellow-500/30 backdrop-blur-sm">
                <div className="flex items-center justify-between">
                  ...
                  <ChevronRight className="w-4 h-4 text-foreground/60 group-hover:text-foreground/80 transition-colors shrink-0" />
                </div>
              </div>
            )}
          </CardContent>
