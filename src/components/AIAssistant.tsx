      ...
      setTimeout(async () => {
        ...
        switch (aiState.type) {
          ...
          case 'general_query':
            addMessage('ai', (
              <>
                Hi there 👋 I'm {LEXI_NAME}, your Digital Paralegal from Creator Armour.
          ...
          case 'onboarding_greeting':
            addMessage('ai', `Welcome to Creator Armour, ${profile.first_name}! I'm your AI assistant. To get your profile set up, I just need to ask a few quick questions about your business.`, aiState.type);
