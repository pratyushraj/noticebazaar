  ...
  const getNextSteps = () => {
    if (riskLevel === 'High') {
      return [
        ...
        { text: 'Schedule Legal Review: Consult with Creator Armour\'s legal advisor to discuss specific changes needed.' },
        ...
        { text: 'Re-Upload for Review: Once revised, upload the new contract to Creator Armour for verification.' },
      ];
