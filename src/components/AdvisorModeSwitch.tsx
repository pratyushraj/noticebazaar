...
export const AdvisorModeSwitch = ({ mode, onToggle }: AdvisorModeSwitchProps) => {
  return (
    <div className="relative inline-flex items-center p-1 rounded-full bg-card backdrop-blur-xl border border-border shadow-[0_2px_8px_rgba(0,0,0,0.1)]">
      {/* Sliding indicator */}
      <div
        className={clsx(
          ...
          mode === "ca" 
            ? "left-1 right-1/2 bg-gradient-to-r from-blue-500/30 to-purple-500/30 border-info/40 shadow-[0_0_8px_rgba(59,130,246,0.2)]"
      ...
      <button type="button"
        ...
        className={clsx(
          ...
          mode === "ca"
            ...
            : "text-foreground/60 hover:text-foreground/80 cursor-pointer active:scale-95"
        )}
