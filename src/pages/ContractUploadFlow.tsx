...
const ContractUploadFlow = () => {
  ...
  const handleShareEmail = () => {
    ...
    const shareMessage = `Hi 👋, sharing our collaboration details here on Creator Armour:\n\n🔐 Secure Deal Page:\n\n${collaborationLink}\n\nPlease review the terms and confirm so we can proceed smoothly 🙂`;
                        ...
                        if (totalRiskAreas > 0) {
                          ...
                          return (
                            <>
                              <div className="mb-2">
                                <p
                                  className={`text-sm md:text-base font-semibold ${isLowRisk ? 'text-green-400' : resultsRiskInfo.color
                                    } flex items-center justify-center gap-2`}
                                >
                                ...
                                <p className="text-xs md:text-sm text-foreground/70 mt-1 max-w-xs mx-auto">
                                  {isLowRisk
                                    ...
                                    }. Fixing them can raise your score above ${potentialScore >= 90 ? '90' : potentialScore
