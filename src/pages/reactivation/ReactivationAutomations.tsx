...
const AUTOMATIONS: Automation[] = [
  ...
  },
  {
    ...
    description: "Convert trial members before they walk out the door",
    icon: RefreshCw,
    iconColor: 'text-violet-400',
    iconBg: 'bg-violet-500/15',
    accentColor: 'border-l-violet-500',
    trigger: 'Trial membership expires in 3 days',
    action: 'Send conversion offer (10% off first month)',
    frequency: 'Once per customer',
    status: 'paused',
    category: 'Conversion',
    stats: {
