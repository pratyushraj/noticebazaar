...
const PreviewAmanParmar = () => {
  ...
  return (
    <main className="min-h-screen bg-[#05070f] text-foreground">
      <div className="sticky top-0 z-40 border-b border-border bg-[#11142a] px-4 py-2 text-center text-xs font-medium tracking-wide text-warning">
        ...
        <div className="rounded-2xl border border-border bg-background">
          <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm text-muted-foreground/85 sm:text-base">
                Govt Schemes | Bank Loans | Strategic Debt Structuring
              </p>
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <button type="button" className="rounded-xl bg-gradient-to-r from-cyan-400 to-blue-500 px-6 py-3 text-sm font-semibold text-muted-foreground hover:from-cyan-300 hover:to-blue-400">
                  Check Eligibility
                </button>
                <button type="button" className="rounded-xl border border-border/25 bg-card px-6 py-3 text-sm font-semibold text-foreground hover:bg-secondary/50">
                  See Success Stories
                </button>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="rounded-2xl border border-border bg-[linear-gradient(145deg,#263678_0%,#18204a_55%,#0e1634_100%)] p-6 min-h-[220px] flex items-end">
                <p className="text-sm text-cyan-100/90">Strategic Debt & MSME Funding Advisory</p>
              </div>
              <div className="rounded-xl border border-border bg-secondary/[0.04] p-4">
                <p className="text-lg font-semibold text-foreground">Aman Parmar</p>
                <p className="text-sm text-muted-foreground">Revenue Head, Satya Support Pvt. Ltd.</p>
      ...
      <section className="mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-2 gap-3 rounded-2xl border border-border bg-secondary/[0.03] p-4 sm:grid-cols-4">
          {stats.map((item) => (
            <div key={item.label} className="rounded-xl border border-border bg-black/25 p-4 text-center">
      ...
      <section className="mx-auto grid max-w-6xl gap-4 px-4 py-10 sm:grid-cols-2">
        <div className="rounded-2xl border border-border bg-secondary/[0.03] p-6">
          <h2 className="text-xl font-semibold">What You Can Get</h2>
          <ul className="mt-4 space-y-3">
            {offerings.map((item) => (
              <li key={item} className="rounded-lg border border-border bg-black/20 px-3 py-2 text-sm text-muted-foreground">
                {item}
              </li>
            ))}
          </ul>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10">
        <div className="rounded-2xl border border-border bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 p-6">
        ...
        <div className="rounded-2xl border border-border bg-secondary/[0.03] p-6">
          ...
          <form onSubmit={onSubmit} className="mt-4 grid gap-3 sm:grid-cols-2">
            <input
              ...
              className="rounded-lg border border-border bg-black/30 px-3 py-2 text-sm outline-none placeholder:text-muted-foreground focus:border-cyan-300/50"
            />
            <input
              required
            ...
            <button
              type="submit"
              className="sm:col-span-2 mt-2 rounded-xl bg-gradient-to-r from-emerald-400 to-cyan-400 px-6 py-3 text-sm font-semibold text-muted-foreground hover:from-emerald-300 hover:to-cyan-300"
            >
      ...
      <section className="mx-auto max-w-6xl px-4 pb-12">
        <div className="rounded-2xl border border-border bg-[linear-gradient(130deg,#1d2f6f_0%,#0e173d_45%,#0a0f21_100%)] p-6 text-center sm:p-10">
          <h2 className="text-2xl font-bold sm:text-3xl">See How Much Funding You Can Unlock in 2 Minutes</h2>
          <button type="button" className="mt-5 rounded-xl bg-card px-6 py-3 text-sm font-semibold text-muted-foreground hover:bg-background">
            Check Eligibility
          </button>
        </div>
      </section>
