    ...
    const fetchCreators = async () => {
      try {
        const { data, error } = await supabase
          ...
          .in('username', ['rohit_cheeku_bhandari', 'shavy.0404', 'cookku_with_chikku', '_cookingwithvineet', 'chroniclesofffoods', 'prachisculinarycanvas', 'thegurgaonfoodie', 'we_are_chefing', 'krishnavi_healthy_bites', 'shinyyy.05', 'jaya_the_explorer', 'simranshah01', 'littleexplorermommy', 'd_dollypatel', 'myspace_vlogs']);
          
        if (error) throw error;

        // Order them exactly as requested if possible, or leave as returned
        const orderedData = [];
        const order = ['rohit_cheeku_bhandari', 'shavy.0404', 'cookku_with_chikku', '_cookingwithvineet', 'chroniclesofffoods', 'prachisculinarycanvas', 'thegurgaonfoodie', 'we_are_chefing', 'krishnavi_healthy_bites', 'shinyyy.05', 'jaya_the_explorer', 'simranshah01', 'littleexplorermommy', 'd_dollypatel', 'myspace_vlogs'];
