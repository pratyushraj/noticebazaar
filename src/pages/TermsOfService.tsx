    ...
    <div className="container mx-auto px-6 py-12 nb-screen-height bg-background">
      ...
      <Card className="max-w-4xl mx-auto bg-card p-8 rounded-xl shadow-lg border border-border">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          <p>
            Welcome to CreatorArmour. These Terms of Service ("Terms") govern your access to and use of the CreatorArmour platform, dashboards, and escrow services (collectively, the "Service"). By accessing or using the Service, you agree to be bound by these Terms.
          </p>

          <h2 className="text-2xl font-bold text-foreground">1. Service Description</h2>
          <p>
            CreatorArmour is an escrow-protected collaboration platform that facilitates secure transactions between Brands and Content Creators. We provide tools for contract generation, shipping tracking, content review, and secure payment holding.
          </p>
          <ul className="list-disc list-inside ml-4 space-y-2">
            ...
            <li><strong>CreatorArmour's Role:</strong> We act as a neutral technology provider and escrow agent. We are not a party to the individual collaboration agreements between Brands and Creators.</li>
          </ul>
          ...
          <ul className="list-disc list-inside ml-4 space-y-2">
            ...
            <li><strong>Disputes:</strong> In the event of a dispute, CreatorArmour reserves the right to hold funds until a resolution is reached or provide mediation services.</li>
          </ul>
