          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 md:p-8">
              ...
              <h2 className="text-2xl md:text-3xl font-black tracking-tight uppercase italic mb-4">
                Start with the core creator workflows
              </h2>
              <p className="text-sm md:text-base text-slate-400 font-medium max-w-2xl mb-6">
                If you are exploring creator operations, these pages cover barter deals, brand discovery, and contract protection.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 pb-20 border-b border-white/5">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <a href="https://x.com/Creator Armour" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-2xl border border-white/10 bg-white/5 text-slate-400 hover:text-[#16A34A] hover:border-[#16A34A]/50 inline-flex items-center justify-center transition-all hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(22,163,74,0.15)]" aria-label="X">
