...
const MobileDashboardDemo = ({ profile, userEmail }: MobileDashboardProps = {}) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#F8F9FA] text-slate-900 font-sans pb-[84px] selection:bg-blue-100 overflow-y-auto w-full h-[100dvh]">
            ...
            <div className="fixed bottom-0 inset-x-0 bg-white/90 backdrop-blur-md border-t border-slate-200/60 px-6 py-2 pb-safe shadow-[0_-10px_40px_rgb(0,0,0,0.05)] sm:block z-40">
