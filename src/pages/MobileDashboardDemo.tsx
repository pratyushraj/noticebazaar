...
const MobileDashboardDemo = ({ profile, userEmail }: MobileDashboardProps = {}) => {
    ...
    return (
        <div className="fixed inset-0 z-[10000] bg-white sm:bg-slate-100 flex justify-center overflow-hidden selection:bg-blue-100">

            {/* Mobile Screen Container */}
            <div className="w-full sm:max-w-[430px] bg-[#F8F9FA] relative h-[100dvh] sm:h-[100dvh] sm:shadow-[0_0_50px_rgba(0,0,0,0.12)] sm:border-x sm:border-slate-200 text-slate-900 font-sans flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden pb-[84px] scrollbar-hide">
                    ...
                    <div className="px-5 space-y-6 pt-5 pb-20">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            {/* Total Earnings Card */}
                            <div className="bg-[#0A2540] rounded-2xl p-4 shadow-xl relative overflow-hidden">
                        ...
                        {/* Filter Pills */}
                        <div className="flex overflow-x-auto snap-x snap-mandatory gap-2 pb-1 -mx-5 px-5 [&::-webkit-scrollbar]:hidden">
                            <button className="snap-start shrink-0 bg-slate-900 text-white px-5 py-2 rounded-full text-[13px] font-semibold shadow-md border border-slate-900">
                                Action Needed <span className="ml-1 text-slate-400">5</span>
                            </button>
                            <button className="snap-start shrink-0 bg-white border border-slate-200 text-slate-600 px-5 py-2 rounded-full text-[13px] font-medium shadow-sm hover:bg-slate-50 transition-colors">
                                In Negotiation <span className="ml-1 text-slate-400">2</span>
                            </button>
                            <button className="snap-start shrink-0 bg-white border border-slate-200 text-slate-600 px-5 py-2 rounded-full text-[13px] font-medium shadow-sm hover:bg-slate-50 transition-colors">
                                Active Contracts <span className="ml-1 text-slate-400">4</span>
                            </button>
                        </div>
                                    ...
                                    <div className="space-y-3 mb-5">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <motion.div
                                                ...
                                                className="flex items-center gap-1.5 bg-orange-50 px-2 py-1 rounded-md border border-orange-200/60"
                                            >
