  ...
  const wrapperClasses =
    variant === 'mobile-fixed'
      ? cn(
        ...
        // Position above bottom nav with safe area when keyboard is closed
        // Position at bottom when keyboard is open (nav is hidden)
        isKeyboardOpen 
          ? "bottom-0 mb-0" 
        ...
        "bg-gradient-to-b from-transparent to-purple-900/90 backdrop-blur-xl",
        // Horizontal padding - reduced vertical padding when keyboard is open for more space
        "px-3",
        isKeyboardOpen ? "py-1.5" : "py-2"
      )
...
export default function MessagesPage() {
  ...
  if (isLoadingPage) {
    return (
      <div className="nb-screen-height flex flex-col items-center justify-center bg-background">
