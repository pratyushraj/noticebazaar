...
const caseStudies = [
  {
    ...
    summary: 'A delayed brand payout had been stuck for 3 months. NoticeBazaar helped formalize the trail and push legal notice action.',
  },
  {
    creator: 'Aryan K.',
    role: 'Tech reviewer',
...
const MarketingHome = () => {
  ...
  return (
    <div className="antialiased">
      ...
      <main className="container mx-auto px-6">
        ...
        <section className="hero-shell grid md:grid-cols-[1.1fr_0.9fr] gap-10 items-center py-16 md:py-20 hero-bg rounded-[2rem] px-6 md:px-10 relative overflow-hidden mt-6" data-aos="fade-up">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-5 text-muted-foreground max-w-2xl text-lg md:text-xl">
              NoticeBazaar gives you a professional workflow for contracts, payout tracking, proof collection, and escalation so a deal does not fall apart the moment a brand goes silent.
            </p>
        ...
        <section className="py-10 md:py-14" data-aos="fade-up">
          <div className="rounded-[2rem] border border-border bg-secondary/[0.03] p-6 md:p-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-lg text-muted-foreground">This is the workflow NoticeBazaar is built for: collect the right facts early, protect the contract, and keep a usable proof trail if payment slips.</p>
            </div>
        ...
        <section className="py-16" data-aos="fade-up">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 mt-3 max-w-2xl mx-auto text-lg">NoticeBazaar is strongest when used before the fight starts: clean briefs, clear contracts, proof trails, and escalation when payment slips.</p>
          </div>
          ...
          <div className="mb-12" data-aos="fade-up">
            <div className="rounded-[2rem] border border-border bg-secondary/[0.03] p-6 md:p-8">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 text-lg text-muted-foreground">NoticeBazaar works best when it replaces vague chat-based deal management with clearer terms, better proof, and a recovery-ready workflow.</p>
              </div>
              <div className="mt-8 overflow-hidden rounded-[1.5rem] border border-border">
                <div className="grid grid-cols-[0.85fr_1fr_1fr] bg-secondary/[0.04] text-sm font-bold text-foreground">
                  ...
                  <div className="border-l border-border p-4 text-info">NoticeBazaar</div>
                </div>
        ...
        <section className="py-16" data-aos="fade-up">
          <div className="rounded-[2rem] border border-border bg-secondary/[0.03] p-6 md:p-8">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-lg text-muted-foreground">NoticeBazaar is not positioned as generic creator SaaS. The trust model is a product workflow backed by legal and compliance specialists when the situation needs real judgment.</p>
            </div>
        ...
        <div className="container mx-auto px-6 py-10 text-gray-400 text-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 border-t border-border/5 pt-8">
            ...
            <div className="md:col-span-2 space-y-6">
              <div className="font-bold text-foreground text-xl">NoticeBazaar</div>
              ...
              <div className="flex items-center gap-4 pt-2">
                ...
                <a
                  href="https://www.linkedin.com/company/noticebazaar"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-foreground transition-colors"
                ...
                <a
                  href="https://www.instagram.com/noticebazaar"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-foreground transition-colors"
            ...
            <div>
              ...
              <div className="mt-1 flex items-center gap-2">
                ...
                <a href="mailto:support@noticebazaar.com" className="hover:text-foreground">Email Support</a>
              </div>
            </div>
          </div>
      ...
      <a href="https://wa.me/919205376316?text=Hi%20NoticeBazaar,%20I%20need%20help" target="_blank" rel="noopener" className="fixed bottom-6 right-6 bg-green-500 p-3 rounded-full shadow-xl z-50 hidden md:flex items-center gap-2 transition-all duration-300 hover:scale-105">
