  ...
  return (
    <CreatorNavigationWrapper title="Collaboration" hidePageTitle compactHeader>
      <div className={cn(sectionLayout.container, "space-y-4 md:space-y-7 pb-28 md:pb-28")}>
        ...
        <div className="flex bg-white/5 p-1 rounded-xl mb-4 md:mb-6 shadow-sm border border-white/10">
          <button
            ...
            className={cn(
              ...
              activeTab === 'requests' ? "bg-white/15 text-white shadow" : "text-white/60 hover:text-white hover:bg-white/5"
            )}
          >
            Brand Requests
          </button>
          <button
            ...
            className={cn(
              "flex-1 py-2 text-sm font-semibold rounded-lg transition-all",
              activeTab === 'link' ? "bg-white/15 text-white shadow" : "text-white/60 hover:text-white hover:bg-white/5"
            )}
          >
            Collab Link
          </button>
        ...
        {activeTab === 'link' ? (
          <div className="space-y-4 md:space-y-7 h-full animate-in fade-in duration-300">
            {/* Hero: Collab Link */}
            <BaseCard
              variant="tertiary"
              className={cn(
