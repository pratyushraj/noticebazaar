  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-foreground">
      ...
      <div className="container mx-auto px-6 py-12">
        <Button 
          asChild 
          className="mb-8 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-foreground border-0 shadow-lg shadow-purple-500/30"
        >
          <Link to="/">
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          ...
          <section className="bg-secondary/50 backdrop-blur-md p-8 rounded-xl border border-border space-y-4">
            <h2 className="text-2xl font-bold text-foreground">Why CreatorArmour Exists</h2>
          ...
          <section className="bg-secondary/50 backdrop-blur-md p-8 rounded-xl border border-border space-y-6">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">1. No Contracts, No Protection</h3>
                <p className="text-secondary leading-relaxed">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">2. Payment Delays Are Normalized</h3>
                <p className="text-secondary leading-relaxed">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">3. Unfair Contract Terms</h3>
                <p className="text-secondary leading-relaxed">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">4. Tax Confusion</h3>
                <p className="text-secondary leading-relaxed">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">5. No One to Turn To</h3>
                <p className="text-secondary leading-relaxed">
          ...
          <section className="bg-secondary/50 backdrop-blur-md p-8 rounded-xl border border-border space-y-6">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">Contracts Create Clarity</h3>
                <p className="text-secondary leading-relaxed">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">Contracts Give You Leverage</h3>
                <p className="text-secondary leading-relaxed">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-foreground">Audit Trail = Proof</h3>
                <p className="text-secondary leading-relaxed">
