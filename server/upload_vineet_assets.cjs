...
async function uploadAssets() {
  ...
  // 2. Upload Avatar
  const avatarPath = '/Users/pratyushraj/.gemini/antigravity/brain/0115895e-d49c-45f2-930e-440cf60527fc/media__1778925266572.jpg';
  if (fs.existsSync(avatarPath)) {
    ...
    if (avatarError) {
      ...
      console.log('✅ Official Anime DP uploaded.');
    }
  } else {
