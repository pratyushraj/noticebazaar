...
async function main() {
  const username = 'goofy.timtim';
  const originalVideoPath = '/Users/pratyushraj/Downloads/goofy.mp4';
  const optimizedVideoPath = join(process.cwd(), 'goofy_reel_insta_optimized.mp4');

  console.log(`🚀 Starting update of Goofy & TimTim's reel using goofy.mp4...`);
  ...
  try {
    ...
    console.log(`🎬 Transcoding goofy.mp4 via FFmpeg...`);
    ...
    console.log('\n✨ Integration Complete! Goofy & TimTim is now live with their custom goofy.mp4 video.');
