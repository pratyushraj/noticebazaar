...
async function main() {
  const reelUrl = 'https://www.instagram.com/reel/DYY7ro9yzin/?igsh=ZWZkN3NwZ3RwcHZ0';
  const username = 'phiphi.theshihtzu';
  const userId = '98038dfe-ff4e-4331-8e77-a10340fb9b38';
  ...
  const { error: updateError } = await supabase
    ...
    .update({ 
      ...
      past_work_added: true // Set to true since she now has past work / discovery reel added
    })
    .eq('id', userId);
