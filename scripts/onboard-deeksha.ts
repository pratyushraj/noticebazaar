...
async function main() {
  const email = 'dikshayadv999@gmail.com';
  const username = 'diksha.v26';
  const fullName = 'Deeksha Yadav';
  const password = 'CreatorArmourDeeksha2026!'; // Temporary password
  const optimizedVideoPath = path.join(process.cwd(), 'scratch', 'deeksha_optimized.mp4');

  console.log(`🚀 Starting Onboarding & Asset synchronization pipeline for Deeksha Yadav (@${username})...`);
  ...
  try {
    ...
    const profileUpdate = {
      ...
      business_name: 'Deeksha Yadav | Aesthetic Fashion & Lifestyle Curation ✨',
      role: 'creator',
      onboarding_complete: true,
      creator_category: 'Fashion & Beauty',
      instagram_followers: 61100,
      followers_count: 61100,
      engagement_rate: 6.8, // Official Meta Interaction Rate from screenshot
      avg_views: 120000,
      avg_reel_views_manual: 120000,
      reel_price: 15000,     // ₹15,000 paid starting rate
      story_price: 3000,      // Stories rate
      starting_price: 15000,
      barter_min_value: 8000, // Barter minimum value
      ...
      city: 'Noida',
      bio: 'Digital Creator 🧿 Noida based. Curation of aesthetic outfit styling lookbooks, daily vlogs, cafes, and premium personal lifestyle narratives 🌸',
      intro_line: 'Verified Noida-based digital creator and model with 61.1K followers and high 6.8% Interaction Rate 💫🌸',
      collab_intro_line: 'Deeksha Yadav features high-impact aesthetic outfit lookbooks, active outdoor vlogs, and premium digital lifestyle partnerships.',
      last_instagram_sync: new Date().toISOString(),
      updated_at: new Date().toISOString(),
 
      // Demographic snapshot from Meta Creator Marketplace
      audience_gender_split: { women: 8.3, men: 91.7 }, // Exact split showing 91.7% Male concentration
      top_cities: ['Delhi', 'Mumbai', 'Lucknow', 'Bengaluru'],
      audience_age_range: '18-24 (65.3%)',
      ...
      // Marketplace Intel
      deal_intelligence: {
        hookRate: 59.9,       // Strong 59.9% hook rate from screenshot
        interactionRate: 6.8,
        accountsReached30d: '2.4M', // From screenshot
        accountsEngaged30d: '221.6K', // From screenshot
        viralPotential: 'High',
        demographicsRelevance: '95.7% India Concentrated, 91.7% Male demographics'
      },
      collab_audience_fit_note: 'High 91.7% Male demographics split concentrated in Delhi NCR, Mumbai, and Lucknow—uniquely optimal for men styling consulting, streetwear launches, consumer tech accessories, and cafe reviews.',
      collab_engagement_confidence_note: 'Stunning 6.8% interaction rate combined with high 2.4M reach and 221.6K engaged monthly accounts.',
      ...
      deal_templates: [
        ...
        },
        {
          ...
          description: 'Barter collaboration - premium product or experience exchange (minimum value ₹8,000+).',
          deliverables: [
            '1 Reel or 2 Stories',
    ...
    const videoFileName = `discovery-deeksha-${Date.now()}.mp4`;
    ...
    const htmlBody = getEmailLayout(ctaButton, 'Deeksha');
