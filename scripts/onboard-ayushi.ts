...
async function main() {
  const email = 'visuayvi2005@gmail.com';
  const username = 'ayushisingh5708';
  const fullName = 'Ayushi Singh';
  const password = 'CreatorArmourAyushi2026!'; // Temporary password
  const optimizedVideoPath = path.join(process.cwd(), 'scratch', 'ayushi_optimized.mp4');

  console.log(`🚀 Starting Onboarding & Asset synchronization pipeline for Ayushi Singh (@${username})...`);
  ...
  try {
    ...
    const profileUpdate = {
      ...
      business_name: 'Ayushi Singh | Travel, Globetrotting & Culinary Curation ✨',
      role: 'creator',
      onboarding_complete: true,
      creator_category: 'Travel & Lifestyle',
      instagram_followers: 13400,
      ...
      location: 'Jamshedpur / Patna, India',
      city: 'Jamshedpur',
      bio: 'Reel Creator 🧿 Naturalist, Globetrotter, Aquaholic, Epicure. Capturing high-aesthetic travel lookbooks, daily lifestyle curation, and culinary reviews ✨',
      intro_line: 'Verified Travel & Lifestyle Creator with 13.4K followers and aesthetic daily curation 📸✨',
      collab_intro_line: 'Ayushi Singh features high-aesthetic visual globetrotting lookbooks, travel narratives, experiential cafe/dining curation, and creative visual collaborations.',
      ...
      top_cities: ['Jamshedpur', 'Patna', 'Delhi', 'Mumbai'],
      audience_age_range: '18-24 (54.5%)',
      ...
      deal_intelligence: {
        hookRate: 45.2,       
        interactionRate: 4.8,
        accountsReached30d: '210K', 
        accountsEngaged30d: '18.4K', 
        viralPotential: 'Medium',
        demographicsRelevance: '95.5% India Concentrated, 68% Female demographics'
      },
      collab_audience_fit_note: 'A healthy 68.0% Female engaged audience concentration—highly optimal for premium skincare labels, cosmetic treatments, boutique retail fashion, cafe launches, and lifestyle staycation experiences.',
      collab_engagement_confidence_note: 'Strong travel and culinary storytelling combined with a consistent daily aesthetic and active engaged community.',
      collab_delivery_reliability_note: 'Active digital creator and globetrotter with high creative visual standards and custom storytelling curation.',
      collab_cta_trust_note: 'Excellent CTR and conversion potential for outdoor cafes, travel products, makeup tutorials, and daily personal care items.',
    ...
    const videoFileName = `discovery-ayushi-${Date.now()}.mp4`;
    ...
    const htmlBody = getEmailLayout(ctaButton, 'Ayushi');
