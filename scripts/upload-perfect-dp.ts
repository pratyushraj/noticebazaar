...
async function main() {
  ...
  const avatarPath = path.join(process.cwd(), 'scratch', 'test_crops', 'real_large', 'nikhil_avatar_real_large_120.png');

  console.log(`🚀 Uploading perfect unedited 120x120 large avatar for @${username}...`);
  ...
  console.log(`\n🎉 @${username} PERFECT ORIGINAL AVATAR FULLY RESTORED AND INSTALLED! 🎉`);
}
