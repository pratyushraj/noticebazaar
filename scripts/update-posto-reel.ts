...
async function main() {
  ...
  const originalVideoPath = '/Users/pratyushraj/Downloads/postothezippypuppy.mp4';
  const optimizedVideoPath = join(process.cwd(), 'posto_reel_insta_optimized.mp4');

  console.log(`🚀 Starting update of Posto Zippy's reel using postothezippypuppy.mp4...`);
  ...
  try {
    ...
    console.log(`🎬 Transcoding postothezippypuppy.mp4 via FFmpeg...`);
    ...
    console.log('\n✨ Integration Complete! Posto Zippy is now live with their custom video.');
