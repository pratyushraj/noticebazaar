...
interface TargetBrand {
  ...
  website: string;
  dbCategory: string;
  nicheLabel: string;      // e.g., "skincare", "healthy food & snacks"
  creatorLabel: string;    // e.g., "skincare routine", "food and lifestyle"
  creatorSourcingLabel: string; // e.g., "skincare", "food"
  onboardingLabel: string; // e.g., "beauty/skincare", "food"
  subject: string;
}
...
const targetBrands: TargetBrand[] = [
  {
    name: 'Munchlet',
    email: 'info@thorishagrotraders.com',
    website: 'https://munchlet.com',
    dbCategory: 'Food, Snacks & Beverages',
    nicheLabel: 'healthy food & snacks',
    creatorLabel: 'food and lifestyle',
    creatorSourcingLabel: 'food',
    onboardingLabel: 'healthy food',
    subject: 'Gourmet Creator Collaboration — Munchlet x Creator Armour 🍯🥞',
  },
  {
    name: 'Formulo',
    email: 'customercare@formulo.in',
    website: 'https://formulo.in',
    ...
    subject: 'Custom Beauty Creator Portal — Formulo x Creator Armour ✨💄',
  },
  {
    name: 'Petalpastee',
    email: 'info@petalpastee.com',
    website: 'https://petalpastee.com',
    dbCategory: 'Beauty, Skincare & Grooming',
    nicheLabel: 'beauty & cosmetics',
    creatorLabel: 'beauty and makeup',
    creatorSourcingLabel: 'beauty',
    onboardingLabel: 'beauty/cosmetics',
    subject: 'Hypoallergenic Cosmetics Creator Shortlist — Petalpastee 🎀💄',
  },
  {
    name: 'Mubble',
    email: 'info@mubblepets.com',
    website: 'https://mubblepets.com',
    dbCategory: 'Pet Care',
    nicheLabel: 'pet care & wellness',
    creatorLabel: 'dog and pet lifestyle',
    creatorSourcingLabel: 'pet',
    onboardingLabel: 'pet care',
    subject: 'Custom Pet Creator Shortlist — Mubble x Creator Armour 🐾🐶',
  }
];
  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 16px; color: #374151; line-height: 1.6; max-width: 650px; margin: 0 auto; padding: 20px;">
      ...
      <p style="margin-top: 30px; border-top: 1px solid #e5e7eb; padding-top: 20px; color: #1f2937;">
        ...
        Creator Armour<br>
        <a href="https://creatorarmour.com" style="color: #0ea5e9; font-weight: bold; text-decoration: none;">creatorarmour.com</a>
      </p>
    </div>
  `;
}
...
async function sendOutreach() {
  console.log(`🚀 Starting custom DM brand outreach to ${targetBrands.length} brands...`);
  const results: any[] = [];
  ...
  for (const b of targetBrands) {
    ...
    try {
      ...
      const leadPayload = {
        ...
        notes: 'Sent personalized creator-outreach email after Instagram DM interaction.'
      };
