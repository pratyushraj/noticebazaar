...
async function main() {
  ...
  const originalVideoPath = '/Users/pratyushraj/Downloads/Video-13.mp4';
  const optimizedVideoPath = join(process.cwd(), 'simba_reel_insta_optimized_13.mp4');

  console.log(`🚀 Starting update of Simba & Sara's reel using Video-13.mp4...`);
  ...
  try {
    ...
    console.log(`🎬 Transcoding Video-13.mp4 via FFmpeg...`);
    ...
    console.log('\n✨ Integration Complete! Simba & Sara is now live with Video-13.mp4.');
