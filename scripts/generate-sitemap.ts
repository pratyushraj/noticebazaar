...
const staticPages = [
  ...
  { loc: '/salons.html', priority: '0.8', changefreq: 'weekly' },
  { loc: '/dental-trends', priority: '0.8', changefreq: 'weekly' },
  { loc: '/dentist-website', priority: '0.8', changefreq: 'weekly' },
  { loc: '/dentist-proposal', priority: '0.8', changefreq: 'weekly' },
