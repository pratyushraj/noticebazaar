...
async function main() {
  const email = 'anushka.chawla87@gmail.com';
  const username = 'anushkaachawla';
  const fullName = 'Anushka Chawla';
  const password = 'CreatorArmourAnushka2026!'; // Temporary password
  const optimizedVideoPath = path.join(process.cwd(), 'scratch', 'anushka_optimized.mp4');

  console.log(`🚀 Starting Onboarding & Asset synchronization pipeline for Anushka Chawla (@${username})...`);
  ...
  try {
    ...
    const profileUpdate = {
      ...
      business_name: 'Anushka Chawla | Too Creative for a Line | Fashion, Beauty & Lifestyle Curation ✨',
      role: 'creator',
      onboarding_complete: true,
      creator_category: 'Fashion & Beauty',
      instagram_followers: 48000,
      followers_count: 48000,
      engagement_rate: 5.5, // Official Meta Interaction Rate from screenshot
      avg_views: 95000,
      avg_reel_views_manual: 95000,
      reel_price: 12000,     // ₹12,000 paid starting rate
      story_price: 2500,      // Stories rate
      starting_price: 12000,
      barter_min_value: 6000, // Barter minimum value
      ...
      city: 'Delhi',
      bio: 'Digital Creator 🧿 New Delhi based. Living too creatively for a single line • Curation of aesthetic outfit styling lookbooks, daily beauty routines, cafe hopping, and premium lifestyle narratives 🌸',
      intro_line: 'Verified New Delhi-based digital creator and model with 48K followers and 5.5% Interaction Rate 💫🌸',
      collab_intro_line: 'Anushka Chawla features highly curated aesthetic outfit styling lookbooks, self-care cosmetic routines, and premium lifestyle brand partnerships.',
      last_instagram_sync: new Date().toISOString(),
      updated_at: new Date().toISOString(),
 
      // Demographic snapshot from Meta Creator Marketplace
      audience_gender_split: { women: 75.5, men: 24.5 }, // Female 75.5% / Male 24.5% split!
      top_cities: ['Delhi', 'Mumbai', 'Ahmedabad', 'Bengaluru'],
      audience_age_range: '18-24 (49.5%)',
      ...
      // Marketplace Intel
      deal_intelligence: {
        hookRate: 42.6,       // Strong 42.6% hook rate from screenshot
        interactionRate: 5.5,
        accountsReached30d: '3.4M', // From screenshot
        accountsEngaged30d: '266.9K', // From screenshot
        viralPotential: 'High',
        demographicsRelevance: '95.5% India Concentrated, 75.5% Female demographics'
      },
      collab_audience_fit_note: 'Exceptional 75.5% Female engaged audience concentration—highly optimal for cosmetic/skincare brands, beauty salons, aesthetic female streetwear, lifestyle personal care, and luxury cafe reviews.',
      collab_engagement_confidence_note: 'Strong 5.5% interaction rate combined with high 3.4M reach and 266.9K engaged monthly accounts.',
      collab_delivery_reliability_note: 'Active digital creator with professional briefs, exceptionally clean outdoor style lookbooks, and high-fidelity video aesthetics.',
      collab_cta_trust_note: 'Excellent click-throughs and conversion metrics for cafe/dining launches, streetwear fashion, lifestyle products, and aesthetic tech accessories.',
      ...
      deal_templates: [
        ...
        },
        {
          ...
          description: 'Barter collaboration - premium product or experience exchange (minimum value ₹6,000+).',
          deliverables: [
            '1 Reel or 2 Stories',
    ...
    const videoFileName = `discovery-anushka-${Date.now()}.mp4`;
    ...
    const htmlBody = getEmailLayout(ctaButton, 'Anushka');
