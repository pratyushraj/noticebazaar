...
async function main() {
  ...
  const originalVideoPath = '/Users/pratyushraj/Downloads/goldenasginger.mp4';
  const optimizedVideoPath = join(process.cwd(), 'ginger_reel_insta_optimized.mp4');

  console.log(`🚀 Starting update of Ginger the Golden's reel using goldenasginger.mp4...`);
  ...
  try {
    ...
    console.log(`🎬 Transcoding goldenasginger.mp4 via FFmpeg...`);
    ...
    console.log('\n✨ Integration Complete! Ginger the Golden is now live with their custom video.');
