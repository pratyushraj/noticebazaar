# Run Social Accounts Migration

The `social_accounts` table needs to be created in your Supabase database. Follow these steps:
...
4. Click **New Query**
5. Copy and paste the entire contents of `supabase/migrations/2025_11_15_update_social_accounts_table.sql`
...
2. You should see `social_accounts` table listed
